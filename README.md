...
```mermaid
flowchart LR
    A[原始語料庫\n(PTT / 維基百科 / WMT / 成語 / 中英句子)] --> B[自定義破音字詞庫校正\n(preprocessing/dictionary.py)]
    B --> C[注音音素轉換\n(pypinyin BOPOMOFO)]
    C --> D[標準大千鍵位映射\n(ZHUYIN_TO_KEY)]
    D --> E[多音字窮舉與隨機取樣\n(DT_v2 / DT_v3)]
...
專案經過多輪長度限制（Sequence Length 32 至 64）與模型版本迭代，實驗成果摘要如下：

| 模型配置 / 長度 | 純中文 (output1) 子序列準確率 | 純英文 (output2) 子序列準確率 | 中英混打 (output3) 子序列準確率 | 特性與結論 |
| :--- | :---: | :---: | :---: | :--- |
| **len32 (v4)** | 78.53% | 56.11% | 39.85%
| **len48 (v5)** | 89.31% | 55.99% | 43.50%
| **len56 (v1)** | 89.39% | **61.89%** | 50.91%
| **len56 (v5)** | **91.30%** | 48.67% | 48.01%
| **len57 (v2)** | 89.03% | 58.48% | 46.73%
| **len62 (v4)** | **91.24%** | 54.81% | 49.27%
